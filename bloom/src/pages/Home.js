  ...
  return (
    <>
      ...
      <div className="container-fluid">
        <div className="swip">
          <div className="col-lg-4 swipside">
            <h1>Bloom</h1>
            <p>Wear it Own it</p>
          </div>
      ...
      <div className="container-fluid p-5">
        <div className="c11  ">
          {/* <div className="col-lg-3 c1a">
            <Link className="lin" to="/twm">
              Shirts
            </Link>
          </div> */}
          <div className="col-lg-3 c1b ">
            <div>
              <Link className="lin" to="/twm">
                TShirts
              </Link>
          ...
          {/* <div className="col-lg-3 c1d">
            <Link className="lin" to="/fwm">
              Trendy Shoes
            </Link>
          </div> */}
          <div className="col-lg-3 c1e">
            <div>
      ...
      <div className="container-fluid">
        <div className="c11">
          <div className="col-lg-3 c2a">
            <Link className="lin" to="/iww">
              sarees
            </Link>
          </div>
          <div className="col-lg-3 c2b">
            <Link className="lin" to="/iww">
              Kurtis
            </Link>
          </div>
          {/* <div className="col-lg-3 c2c">
            <Link className="lin" to="/www">
              western
            </Link>
          </div> */}
          <div className="col-lg-3 c2d">
            <Link className="lin" to="/sww">
              Sports
            </Link>
          </div>
          <div className="col-lg-3 c2e">
            <Link className="lin" to="/fww">
              Footwear
            </Link>
          </div>
          {/* <div className="col-lg-3 c2f">
            <Link className="lin" to="/www">
              Tops
            </Link>
          </div> */}
      ...
      <div className="container-fluid">
        <div className="c11">
          <div className="col-lg-3 c3a">
            <Link className="lin" to="/bk">
              Casuals
            </Link>
          </div>
          {/* <div className="col-lg-3 c3b">
            <Link className="lin" to="/gk">
              Girls Ethnics
            </Link>
          </div> */}
          <div className="col-lg-3 c3c">
            <Link className="lin" to="/bk">
              Boys Ethnics
            </Link>
          </div>
          {/* <div className="col-lg-3 c3d">
            <Link className="lin" to="/bk">
              Flipons
            </Link>
          </div> */}
          <div className="col-lg-3 c3e">
            <Link className="lin" to="/gk">
              Shoes
            </Link>
          </div>
          <div className="col-lg-3 c3f">
